...
Test(my_printf, flag_a_round_1, .init = redirect_all_std)
{
    int len = my_printf("%.1a", 1.9999);
    cr_assert_stdout_eq_str("0x2.0p+0");
    cr_assert_eq(len, 8);
}

Test(my_printf, flag_biga_round_1, .init = redirect_all_std)
{
    int len = my_printf("%.1A", 1.9999);
    cr_assert_stdout_eq_str("0X2.0P+0");
    cr_assert_eq(len, 8);
...
Test(my_printf, flag_a_round_2, .init = redirect_all_std)
{
    int len = my_printf("%.1a", 1.49);
    cr_assert_stdout_eq_str("0x1.8p+0");
    cr_assert_eq(len, 8);
}

Test(my_printf, flag_biga_round_2, .init = redirect_all_std)
{
    int len = my_printf("%.1A", 1.49);
    cr_assert_stdout_eq_str("0X1.8P+0");
    cr_assert_eq(len, 8);
...
Test(my_printf, flag_a_round_3, .init = redirect_all_std)
{
    int len = my_printf("%.3a", 1.4999);
    cr_assert_stdout_eq_str("0x1.800p+0");
    cr_assert_eq(len, 10);
}

Test(my_printf, flag_biga_round_3, .init = redirect_all_std)
{
    int len = my_printf("%.3A", 1.4999);
    cr_assert_stdout_eq_str("0X1.800P+0");
    cr_assert_eq(len, 10);
